        ...
        <div
          ...
          <div
            ...
            <p className="leading-8 text-gray-500 mb-4 " data-aos="fade-up">
              We carefully identify and nurture the best talents from over 50
              african countries.
            </p>
            <div
              data-aos-duration="2000"
              ...
              <p className="leading-8 text-gray-500 mb-4" data-aos="fade-up">
                Moreover, we carefully adapt each role to suit your particular
                requirements.
              </p>
            </div>
          ...
          <div
            ...
            <p className="leading-8 text-gray-500 mb-4">
              Whether you need one or multiple talents, Mozisha streamlines the
              process, allowing you to scale your team within a few days.
            </p>
            <div
              data-aos-duration="2000"
              data-aos="fade-up"
              ...
              <p data-aos="fade-up" className="leading-8 text-gray-500 mb-4">
                Our smooth onboarding process keeps your operations agile and
                flexible.{" "}
              </p>
            </div>
            <button onClick={handleGetStartedClick}
        ...
        <div
          ...
          <div
            ...
            <div
              ...
              <p>
                We don't just offer talents; we seamlessly integrate a new team
              ...
              <div
                ...
                <div data-aos-duration="2000" data-aos="fade-up">
                  ...
                  <p className="text-gray-500 leading-8">
                    Grant them access to your company email, Slack, Zoom, and
                    other relevant tools. Also, remember to include them in your
                ...
                <div data-aos-duration="2000" data-aos="fade-up">
                  ...
                  <p className="text-gray-500 leading-8">
                    Our talents operate during your standard business hours,
              ...
              <div
                ...
                <div data-aos-duration="2000" data-aos="fade-up">
                  ...
                  <p className="text-gray-500 leading-8">
                    Our skilled professionals work full-time, dedicating 40
                    hours a week exclusively to your tasks and projects.
                  </p>
                </div>
                <div data-aos-duration="2000" data-aos="fade-up">
                  <span className="text-purple-600 text-6xl ">
                  ...
                  <p className="text-gray-500 leading-8">
                    Engaging global talent can seem daunting at first, but we're
                    here to provide you with continuous support.
                  </p>
                </div>
              </div>
            </div>
